...
class HostPage extends Component {
    ...
    addIntoLiveStream = (streamId) => {
        ...
        if (streamId.includes('screen')) {
            ...
            this.state.liveSteaming.push(`video${streamId}`)
            let canvas = document.querySelector('canvas');
            let ctx = canvas.getContext("2d");
            // let width = 990
            // let height = 540
            // let length = this.state.liveSteaming.length ? this.state.liveSteaming.length : 1;
            ...
            //     this.draw(width, height, length, ctx)
            // }, 10)
            function draw() {
                ctx.drawImage(video, 0, 0, 990, 540);
    ...
    setLiveTranscoding = () => {
        ...
        if (this.state.currentScreenShare != null) {
            let screenConfig = Object.assign({}, canvasConfig)
        ...
        let userConfig = Object.assign({}, canvasConfig)
    ...
    addBanner = () => {
        ...
        if (this.state.banner != "") {
            ctx.fillStyle = "red";
            ctx.fillRect(0, 475, 990, 40);
            ctx.fillStyle = "white";
            ctx.font = "35px Georgia";
            ctx.textAlign = "center";
            ctx.fillText(this.state.banner, 495, 505)
        } else {
            ctx.clearRect(0, 0, 990, 540);
        }
        ...
        return (
            <div className="main-container">
                <div className="live-stream-display" id="live_stream">
                    <canvas width="990px" height="540px" style={{ position: 'absolute', top: 0, left: 0, zIndex: 5 }}></canvas>
